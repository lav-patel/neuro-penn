...
my_packages <- c('tidyverse', 'readxl', 'DT', 'rcartocolor', 'gghighlight', 
                 'cowplot', 'broom', 'devtools', 'tableone','epitools')
...
#clin_raw$patient_num <- toString(clin_raw$patient_num)
#demo_raw$patient_num <- toString(demo_raw$patient_num)
#obs_raw$patient_num <- toString(obs_raw$patient_num)
```
